...
//    3. Loop through the selected answer to see if they are correct or not (Check the value of the answer
// to see if it is the string "true")
//    4. For each correct answer add the class `correct` to the parent with the class `question-item` and 
//remove the class `incorrect`.
...
//    7. BONUS: If all answers are correct show the element with the id `alert` and hide it after one
// second (look into setTimeout) (use the class active to show the alert and remove the class to hide it)
